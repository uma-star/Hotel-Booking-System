...
public class Checkout extends JFrame implements ActionListener{
    ...
    Checkout()
    {
        ...
        JButton text = new JButton("Checkout");
       ...
       try 
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/db.jpeg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == checkout) {
            ...
            String selectedCustomer = customer.getSelectedItem();
